...
function() {
    ...
    c.Queue = {
        add: function(a, b, d) {
            ...
            // c.Queue.process())
            d.updateCart && ("undefined" != typeof SECOMAPP && "undefined" != typeof Shopify && "function" == typeof Shopify.getCart ? e.success.push(function(t) {
					Shopify.getCart(function(t) {
						c.cart.update(t), jQuery(document).trigger("cart.requestComplete", [t])
					}, t)
				}) : e.success.push(c.cart.update)),
            g.push(e),
            (f ? void 0 : (jQuery(document).trigger("cart.requestStarted", [c.cart]),
            c.Queue.process())), ("function" == typeof Shopify.reRenderCartCustom ? Shopify.reRenderCartCustom() : function() {})
