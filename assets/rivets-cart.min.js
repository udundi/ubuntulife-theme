...
(function() {
    ...
    b.prototype.realize = function() {
        ...
        return this.tokens.forEach(function(e, f) {
            c(b) ? ("undefined" != typeof this.objectPath[f] ? b !== (a = this.objectPath[f]) && (this.set(!1, e, a, this.update),
            this.set(!0, e, b, this.update),
            this.objectPath[f] = b) : (this.set(!0, e, b, this.update),
            this.objectPath[f] = b),
    ...
    b.prototype.update = function() {
        ...
        b = this.value(),
        this.target = a,
        (this.value()instanceof Function || this.value() !== b) && this.callback())
    }
    ,
...
function() {
    ...
    c.Utils = {
        ...
        formatMoney: function(a, b, e, f) {
            ...
            null != window.Currency && f !== c.settings.currency && (a = Currency.convert(a, c.settings.currency, f),
            null != (null != (g = window.Currency) ? g.moneyFormats : void 0) && f in window.Currency.moneyFormats && (b = window.Currency.moneyFormats[f][e])),
            null != (null != (h = window.Shopify) ? h.formatMoney : void 0) ? Shopify.formatMoney(a, b) : (c.Utils.warn(d),
            a)
        },
    ...
    c.Queue = {
        add: function(a, b, d) {
            ...
            // g.push(e),
            // f ? void 0 : (jQuery(document).trigger("cart.requestStarted", [c.cart]),
            // c.Queue.process())
            d.updateCart && ("undefined" != typeof SECOMAPP && "undefined" != typeof Shopify && "function" == typeof Shopify.getCart ? $.proxy(e.success.push(function(t) {
					Shopify.getCart(function(t) {
						c.cart.update(t), jQuery(document).trigger("cart.requestComplete", [c.cart])
					}, t)
				}), c) : e.success.push(c.cart.update)), g.push(e), f ? void 0 : (jQuery(document).trigger("cart.requestStarted", [c.cart]), c.Queue.process())
        },
        process: function() {
            var a;
            return g.length ? (f = !0,
    ...
    c.Data = {
        ...
        update: function(a) {
            ...
            d = {},
            d.selling_plan = b.attr("data-cart-selling-plan"),
            c.Core.updateItem(b.attr("data-cart-update"), b.attr("data-cart-quantity"), d)
        },
        updateById: function(a) {
            ...
            d = {},
            d.selling_plan = b.attr("data-cart-selling-plan"),
            c.Core.updateItemById(b.attr("data-cart-update-id"), b.attr("data-cart-quantity"), d)
        },
        clear: function(a) {
            return a.preventDefault(),
            c.Core.clear()
